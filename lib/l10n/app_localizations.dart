...
abstract class AppLocalizations {
  ...
  /// A category for educational courses.
  ///
  /// In en, this message translates to:
  /// **'Courses'**
  String get courses;

  /// A category for instructors or educators.
  ///
  /// In en, this message translates to:
  /// **'Teachers'**
  String get teachers;
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['en', 'es', 'fr', 'hi', 'ja', 'ko', 'ne', 'zh'].contains(locale.languageCode);
